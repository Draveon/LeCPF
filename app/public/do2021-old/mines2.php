...
echo '<div class="localtable630"><br>	<td colspan="5">'.subtitle_papyrus('Vos possessions minières').'&nbsp;</td>
<br>	<td><h4>Soufre</h4></td>
	<td><h4>Mercure</h4></td>
	<td><h4>Cristaux</h4></td>
	<td><h4>Gemmes</h4></td>
<br>	<td><img src="/images/terrain/mine_soufre.gif"   title="Mines de soufre"  ></td>
	...
	<td><img src="/images/terrain/mine_gemmes.gif"   title="Mines de gemmes"  ></td>
<br>	<td>Gain '.$parjour.' : '.$ress_trans['soufre']. '</td>
	<td>Gain '.$parjour.' : '.$ress_trans['mercure'].'</td>
	<td>Gain '.$parjour.' : '.$ress_trans['cristal'].'</td>
	<td>Gain '.$parjour.' : '.$ress_trans['gemme'].  '</td>
<br>	<td>Réserve  : '.$res_soufre. '</td>
	<td>Réserve  : '.$res_mercure.'</td>
	<td>Réserve  : '.$res_cristal.'</td>
	<td>Réserve  : '.$res_gemme.  '</td>
</div>';
