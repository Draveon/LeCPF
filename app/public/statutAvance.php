  ...
  <div class="row">
    ...
    // prochaines ventes sur le marché central
    	...
    	while ($data = mysql_fetch_row($req))
    	{
    		...
    		echo '
        <div class="container-fluid">
          <div style="'.$paddingItem.'" class="row">
           <a class="view_data_market discreb" href="#" data-toggle="modal" data-target="#modal_foire">
             <img width="45px" height="45px" src="'.$image.'" alt="'.$item.'" id="'.$id.'">'.$texte.'
        ...
        ?>
          ...
          <script>
            ...
            var items = storage.setItem('items', {
              $item_id
            });
          </script>

        <div class="col-md-12 modal fade" id="modal_foire" tabindex="-1" role="dialog" aria-labelledby="modal_connectLabel" aria-hidden="true">
          <div class="modal-dialog modal_sign" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modal_connectLabel"><?php echo $item_affiche ?></h5>
