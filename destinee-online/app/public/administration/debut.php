...
function entete($x){
    ...
    background-image: URL(/images/splitbar.gif);"></td></tr></tbody></table>
    <?if ($connexion == 1){
        echo "<strong>Niveau :</strong> $niveau | <strong>Puissance :</strong> $puissance | <strong>Expérience :</strong> $exp | <strong>Pièces d'or :</strong> $argent | <strong>Mana :</strong> $mana | <strong>Rang :</strong> $rang";
    }
    else{
        echo "<br>";
    }?>
