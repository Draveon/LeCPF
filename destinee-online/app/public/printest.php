...
if ($_SESSION['connexion'] == 1)
{
	...
	// on gagne un peu d'xp en se connectant toutes les 24h à son compte (en fonction de sa puissance et de son niveau)
	include("faction_nouveau_niveau.php");
...
<table class="entetetableindex"><tbody>
	...
	if ($connexion == 1)	echo '<p class="statsHero"><strong>Niveau :</strong> '.$niveau.' | <strong>Puissance :</strong> '.$puissance.' | <strong>Xp :</strong> '.$exp.' / '.$but.' | <strong>Pièces d\'or :</strong> '.$argent.' | <strong>Mana :</strong> '.$mana.' | <strong>Rang :</strong> '.$rang.' </p>';
	else			echo "";
